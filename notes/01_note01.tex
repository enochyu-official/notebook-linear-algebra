...
numbers that do not have direction.
\end{definition}

A Vector is a more general term that includes different objects like
...
\textbf{linearly independent} if all scalars are zero in the equation.
\end{definition}
